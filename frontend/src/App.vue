...
import FootnoteInput from "@/routes/kitchensink/FootnoteInput.vue"
import FootnoteInputAsList from "@/routes/kitchensink/FootnoteInputAsList.vue"
...
const EXAMPLE_FOOTNOTES: Footnote[] = [
  ...
  {
    parts: [
      { type: FootnoteSectionType.FEDERAL_LAW, content: "" },
      {
        type: FootnoteSectionType.COMMENT_FOOTNOTE,
        content: "einfach nur ein Kommentar",
      },
      {
        type: FootnoteSectionType.COURT_DECISION,
  ...
  },
  {
    ...
    parts: [
      {
        type: FootnoteSectionType.OTHER_FOOTNOTE,
        content:
...
const TYPE_TO_ABBREVIATION: Record<FootnoteSectionType, string> = {
  [FootnoteSectionType.CHANGE_FOOTNOTE]: "ÄND",
  [FootnoteSectionType.COMMENT_FOOTNOTE]: "KOM",
  [FootnoteSectionType.COURT_DECISION]: "BVerfG",
  [FootnoteSectionType.FEDERAL_LAW]: "LAND",
  [FootnoteSectionType.EUROPEAN_UNION_LAW]: "EU/EG",
  [FootnoteSectionType.OTHER_FOOTNOTE]: "SO",
}
